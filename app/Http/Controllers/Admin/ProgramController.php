...
class ProgramController extends Controller
{
    ...
    {
        $details = $this->program->orderBy('created_at','desc')->get();
        return view('admin.program.list',compact('details'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->program->create($value);
        return redirect()->route('program.index')->with('message','Program Added Succssfully');
    }
    ...
    {
        $detail = $this->program->findOrFail($id);
        return view('admin.program.edit',compact('detail'));
    }
    ...
    public function imageProcessing($image){
       $input['imagename'] = time().'program.'.$image->getClientOriginalExtension();
       $thumbPath = public_path('images/thumbnail');
       $mainPath = public_path('images/main');
       $listingPath = public_path('images/listing');
